...
public class Cyclop extends Enemy implements PlayerPositionObserver {
        ...
        if(isJumping) {
            ...
            if(this.collidesWith(phantom)) {
                ...
                for (int i = 0; i < 10; i++) {
                    ...
                    GameObjectManager.spawn(new Boulder(x + 24, y + 24, new Point(targetX, targetY), SpellTarget.Player));
                }
            }
    ...
    public void draw(){
        ...
        graphics.fillRect(100, 100, (int) ((double)health / 40 * 600), 20);
