...
public class DarkWizard extends Enemy implements PlayerPositionObserver {
    private int bulletCount = 16;
    private int spreadAngle = 25;
    ...
    public void update() {
        ...
        if(spawnCooldown.isAvailable() && isJumping){
            spawnCooldown.use();
            GameObjectManager.spawn(new Spirit(48 * 5, 48 * 6));
            GameObjectManager.spawn(new Spirit(48 * 7, 48 * 6));
            GameObjectManager.spawn(new Spirit(48 * 9, 48 * 6));
        }
    ...
    public void draw(){
        ...
        graphics.fillRect(100, 100, (int) ((double)health / 120 * 600), 20);
